...
class EventHandler {
  ...
  void init() {
    _onEvent(
      "activated".toJS,
      (() => _activatedStreamController.add(true)).toJS,
    );
    _onEvent(
      "deactivated".toJS,
    ...
    _onEvent(
      "themeChanged".toJS,
      (() => _themeChangedStreamController.add((
        WebApp().colorScheme,
        WebApp().themeParams,
      ))).toJS,
    );
    _onEvent(
      ...
      ((JSBoolean isStateStable) => _viewportChangedStreamController.add((
        isStateStable.toDart,
        WebApp().viewportHeight,
      ))).toJS,
    );
    _onEvent(
      "safeAreaChanged".toJS,
      (() => _safeAreaChangedStreamController.add(WebApp().safeAreaInset)).toJS,
    );
    _onEvent(
      "contentSafeAreaChanged".toJS,
      (() => _contentSafeAreaChangedStreamController.add(
        WebApp().contentSafeAreaInset,
      )).toJS,
    );
    _onEvent(
      "mainButtonClicked".toJS,
      (() => _mainButtonClickedStreamController.add(WebApp().mainButton)).toJS,
    );
    _onEvent(
      "secondaryButtonClicked".toJS,
      (() => _secondaryButtonClickedStreamController.add(
        WebApp().secondaryButton,
      )).toJS,
    );
    _onEvent(
      "backButtonClicked".toJS,
      (() => _backButtonClickedStreamController.add(WebApp().backButton)).toJS,
    );
    _onEvent(
      "settingsButtonClicked".toJS,
      (() => _settingsButtonClickedStreamController.add(
        WebApp().settingsButton,
      )).toJS,
    );
    _onEvent(
      "invoiceClosed".toJS,
      ((JSString url, JSString status) => _invoiceClosedStreamController.add((
        url.toDart,
        InvoiceResult.fromName(status.toDart),
      ))).toJS,
    );
    _onEvent(
      "popupClosed".toJS,
      ((JSString? buttonId) => _popupClosedStreamController.add(
        buttonId?.toDart,
      )).toJS,
    );
    _onEvent(
      "qrTextReceived".toJS,
      ((JSString data) => _qrTextReceivedStreamController.add(
        data.toDart,
      )).toJS,
    );
    _onEvent(
      "scanQrPopupClosed".toJS,
      ((JSString? buttonId) => _scanQrPopupClosedStreamController.add(
        true,
      )).toJS,
    );
    _onEvent(
      "clipboardTextReceived".toJS,
      ((JSString? data) => _clipboardTextReceivedStreamController.add(
        data?.toDart,
      )).toJS,
    );
    _onEvent(
      "writeAccessRequested".toJS,
      ((JSString status) => _writeAccessRequestedStreamController.add(
        WriteAccessRequestedStatus.fromName(status.toDart),
      )).toJS,
    );
    _onEvent(
      "contactRequested".toJS,
      ((JSString status) => _contactRequestedStreamController.add(
        ContactRequestedStatus.fromName(status.toDart),
      )).toJS,
    );
    _onEvent(
      "biometricManagerUpdated".toJS,
      ((JSString status) => _biometricManagerUpdatedStreamController.add(
    ...
    _onEvent(
      ...
      ((JSBoolean isAuthenticated, JSString? biometricToken) =>
              _biometricAuthRequestedStreamController.add((
                isAuthenticated.toDart,
                biometricToken?.toDart,
              )))
          .toJS,
    );
    _onEvent(
      "biometricTokenUpdated".toJS,
      ((JSBoolean isUpdated) => _biometricTokenUpdatedStreamController.add(
        isUpdated.toDart,
      )).toJS,
    );
    _onEvent(
      "fullscreenChanged".toJS,
      (() => _fullscreenChangedStreamController.add(
        WebApp().isFullscreen,
      )).toJS,
    );
    _onEvent(
      "fullscreenFailed".toJS,
      ((JSString error) => _fullscreenFailedStreamController.add(
        FullscreenFailedError.fromName(error.toDart),
      )).toJS,
    );
    _onEvent(
      "homeScreenAdded".toJS,
    ...
    _onEvent(
      ...
      (() => _accelerometerStartedStreamController.add(
    ...
    _onEvent(
      ...
      (() => _accelerometerChangedStreamController.add(
        WebApp().accelerometer,
      )).toJS,
    );
    _onEvent(
      "accelerometerFailed".toJS,
      ((JSString error) => _accelerometerFailedStreamController.add(
        AccelerometerFailedError.fromName(error.toDart),
      )).toJS,
    );

    _onEvent(
      "deviceOrientationStarted".toJS,
      (() => _deviceOrientationStartedStreamController.add(
        WebApp().deviceOrientation,
      )).toJS,
    );
    _onEvent(
      "deviceOrientationStopped".toJS,
      (() => _deviceOrientationStoppedStreamController.add(
        WebApp().deviceOrientation,
      )).toJS,
    );
    _onEvent(
      "deviceOrientationChanged".toJS,
      (() => _deviceOrientationChangedStreamController.add(
        WebApp().deviceOrientation,
      )).toJS,
    );
    _onEvent(
      "deviceOrientationFailed".toJS,
      ((JSString error) => _deviceOrientationFailedStreamController.add(
        DeviceOrientationFailedError.fromName(error.toDart),
      )).toJS,
    );

    _onEvent(
      "gyroscopeStarted".toJS,
      (() => _gyroscopeStartedStreamController.add(WebApp().gyroscope)).toJS,
    );
    _onEvent(
      "gyroscopeStopped".toJS,
      (() => _gyroscopeStoppedStreamController.add(WebApp().gyroscope)).toJS,
    );
    _onEvent(
      "gyroscopeChanged".toJS,
      (() => _gyroscopeChangedStreamController.add(WebApp().gyroscope)).toJS,
    );
    _onEvent(
      "gyroscopeFailed".toJS,
      ((JSString error) => _gyroscopeFailedStreamController.add(
        GyroscopeFailedError.fromName(error.toDart),
      )).toJS,
    );

    _onEvent(
      "locationManagerUpdated".toJS,
      (() => _locationManagerUpdatedStreamController.add(
        WebApp().locationManager,
      )).toJS,
    );
    _onEvent(
      "locationRequested".toJS,
      ((LocationDataExternal ext) => _locationRequestedStreamController.add(
        LocationData.fromExternal(ext),
      )).toJS,
    );

    _onEvent(
      "shareMessageSent".toJS,
      (() => _shareMessageSentStreamController.add(true)).toJS,
    );
    _onEvent(
      "shareMessageFailed".toJS,
      ((JSString error) => _shareMessageFailedStreamController.add(
        ShareMessageFailedError.fromName(error.toDart),
      )).toJS,
    );
    ...
    _onEvent(
      ...
      ((JSString error) => _emojiStatusFailedStreamController.add(
        EmojiStatusFailedError.fromName(error.toDart),
      )).toJS,
    );
    ...
    _onEvent(
      ...
      ((JSString status) => _emojiStatusAccessRequestedStreamController.add(
        EmojiStatusAccessRequestedStatus.fromName(status.toDart),
      )).toJS,
    );

    _onEvent(
      "fileDownloadRequested".toJS,
      ((JSString error) => _fileDownloadRequestedStreamController.add(
        FileDownloadRequestedStatus.fromName(error.toDart),
      )).toJS,
    );
  }
  ...
  final StreamController<SafeAreaInset> _safeAreaChangedStreamController =
      StreamController.broadcast();
  Stream<SafeAreaInset> get safeAreaChanged =>
      _safeAreaChangedStreamController.stream;

  final StreamController<ContentSafeAreaInset>
  _contentSafeAreaChangedStreamController = StreamController.broadcast();
  Stream<ContentSafeAreaInset> get contentSafeAreaChanged =>
  ...
  _emojiStatusAccessRequestedStreamController = StreamController.broadcast();
